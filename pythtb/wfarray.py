...
class WFArray:
    ...
    def impose_loop(self, mesh_dir: int):
        ...
        raise NotImplementedError(
            "Looping is handled automatically by Mesh."
        )
    ...
    def set_states(
        ...
        wfs : np.ndarray
            ...
            shape for the given ``Mesh``, ``nstates``, and spin configuration.
        ...
        is_spin_axis_flat : bool, optional
            ...
            is only relevant when ``spinful=True``.
        ...
        if wfs.shape != expected_shape:
            raise ValueError(
                f"wfs shape {wfs.shape} does not match expected shape: "
                f"{expected_shape}"
            )
