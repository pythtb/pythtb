...
def test_centers():
    ...
    ) * bulk_model.lat_vecs[1]
    # periodicity vectors for the wannier center
    bulk_location_periodicity = [bulk_model.lat_vecs[0], bulk_model.lat_vecs[1]]
    ...
    # periodicity vectors for the wannier center
    sc_location_periodicity = [sc_model.lat_vecs[0], sc_model.lat_vecs[1]]
    # make a better choice for the location of the charge center
    # this thing is hard-coded
    sc_location = (
    ...
    def get_centers_01(mod, num_bands):
        ...
        ret_center = (ph0 / (2.0 * np.pi)) * mod.lat_vecs[0] + pos1 * mod.lat_vecs[1]
        # periodicity vectors for the center of charge
        ret_periodicity = [mod.lat_vecs[0]]
