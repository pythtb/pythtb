...
- New readthedocs-based [documentation site](https://pythtb.readthedocs.io/en/latest/index.html)

This document highlights the design philosophy, API changes, and migration guidance. For a full list of changes, see the [Changelog](https://pythtb.readthedocs.io/en/latest/CHANGELOG.html). For detailed usage, see the updated [documentation](https://pythtb.readthedocs.io/en/latest/index.html/) and [tutorials](https://pythtb.readthedocs.io/en/latest/tutorials.html).
